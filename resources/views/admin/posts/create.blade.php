<x-app-layout>
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white">📝 Create New Post</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Write and share a beautiful blog post.</p>
            </div>
        ...
        @foreach ($categories as $category)
            <label class="inline-flex items-center space-x-2">
                <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                    class="text-blue-600 rounded focus:ring-0 dark:bg-gray-800 dark:border-gray-700">
        ...
        @endforeach
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="short_description" rows="3"
                        class="mt-1 rounded-lg w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white">{{ old('short_description') }}</textarea>
                </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea id="content-editor" name="description" rows="12"
                        class="mt-1 rounded-lg w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white">{{ old('description') }}</textarea>
                </div>

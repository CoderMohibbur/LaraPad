<x-app-layout>
    <div class="max-w-xl mx-auto p-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">＋ Add New Category</h2>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit"
                        class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-md">Create</button>
            </div>
        </form>
    </div>
</x-app-layout>

<x-guest-layout>
    ...
    <section class="border-b">
        <div class="py-16 max-w-screen-xl mx-auto text-center lg:text-left px-3">
            <h1 class="font-bold text-5xl lg:text-7xl">Award-winning Agency</h1>
            <p class="text:xl lg:text-2xl text-[#5d7183] pt-6">We hold a solid reputation for being a trusted provider of quality Search Engine Marketing services.</p>
        </div>
    </section>
    <!-- Awards -->
    <div class="max-w-screen-xl mx-auto px-3">
        ...
        <div class="mt-8 mb-20">
            <h2 class="text-center py-10 text-3xl font-bold">But that’s not all:</h2>
            <div class="grid grid-cols-1 lg:grid-cols-3">
                <div class="px-5 lg:pr-10">
                    <h2 class="text-xl font-semibold pb-5">Clutch Awards</h2>
                    <ul>
                        <li class="flex items-center gap-3 pb-3">
                            <div class="rounded-full w-[15px] h-[12px] bg-[#31bcee]"></div>
                            <p>Top SEO Consultant, 2019 Cody Jensen (Founder & CEO)</p>
                        </li>
                        <li class="flex items-center gap-3 pb-3">
                            <div class="rounded-full w-[15px] h-[12px] bg-[#31bcee]"></div>
                            <p>Top SEO Consultant, 2019 Cody Jensen (Founder & CEO)</p>
                ...
                <div class="lg:border-l-2 px-5 lg:pl-5 lg:pr-10 border-[#ecf1f8]">
                    <h2 class="text-xl font-semibold pb-5">More Awards</h2>
                    <ul>
                        <li class="flex items-center gap-3 pb-3">
                            <div class="rounded-full w-[15px] h-[12px] bg-[#31bcee]"></div>
                            <p>Top SEO Consultant, 2019 Cody Jensen (Founder & CEO)</p>

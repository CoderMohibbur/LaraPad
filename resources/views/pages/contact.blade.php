<x-guest-layout>
  ...
  <style>
    ...
    /* ▼ Placeholder tune */
    .ph::placeholder{color:rgb(100 116 139 / .7);}          /* text-slate-500 @ 70% */
    .dark .ph::placeholder{color:rgb(148 163 184 / .55);}    /* text-slate-400 @ 55% */
    ...
    .rise{animation:riseIn .6s cubic-bezier(.2,.7,.2,1) .05s both}
  </style>

  <!-- =================== CONTACT HERO =================== -->
  <section class="relative overflow-hidden border-b bg-white dark:bg-[#0b1220] dark:border-gray-800"><grammarly-extension data-grammarly-shadow-root="true" style="position: absolute; top: 0px; left: 0px; pointer-events: none; --rem: 16;" class="dnXmp"></grammarly-extension><grammarly-extension data-grammarly-shadow-root="true" style="position: absolute; top: 0px; left: 0px; pointer-events: none; --rem: 16;" class="dnXmp"></grammarly-extension>
    <!-- ambient glows -->
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-12 pt-24 pb-12 lg:pt-12">
      <div class="grid lg:grid-cols-12 gap-12 items-start lg:items-center">
        ...
        <div class="lg:col-span-7 aos-init aos-animate" data-aos="fade-right">
          ...
          <div class="mt-8 glass soft-shadow border border-slate-200/60 dark:border-slate-700/50 rounded-2xl p-6 rise aos-init aos-animate" data-aos="fade-up" data-aos-delay="60">
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <ul class="space-y-2 text-[15px] text-slate-600 dark:text-slate-400">
                  <li class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2 8.5C2 5.46 5.46 2 8.5 2h7A6.5 6.5 0 0 1 22 8.5v7A6.5 6.5 0 0 1 15.5 22h-7A6.5 6.5 0 0 1 2 15.5v-7Z"></path><path stroke-linecap="round" stroke-linejoin="round" d="M6 8h.01M12 16.5a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z"></path></svg>
                    <a href="tel:+8801404282727" class="hover:text-cyan-600">+8801404282727</a>
                  </li>
                  <li class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l9 6 9-6M21 8v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8"></path></svg>
              ...
              <!-- Business Hour -->
              <div>
                <h3 class="text-base font-semibold text-slate-900 dark:text-white mb-3">Business Hour</h3>
                <ul class="space-y-2 text-[15px] text-slate-600 dark:text-slate-400">
                  <li class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6l4 2"></path></svg>
                    Sat–Wed: 10 AM – 7 PM
                  </li>
                  <li class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6l4 2"></path></svg>
              ...
              <div>
                ...
                <p class="flex items-center gap-2 text-[15px] text-slate-600 dark:text-slate-400">
                  <svg class="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21c4.97-4.418 8-7.731 8-11a8 8 0 1 0-16 0c0 3.269 3.03 6.582 8 11z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                  Dhaka, Bangladesh
                </p>
              </div>
          ...
          <div class="glass soft-shadow border border-slate-200/60 dark:border-slate-700/50 rounded-2xl p-6 md:p-7">
            ...
            <form method="POST" action="#" class="mt-5 space-y-4">
              ...
              <div>
                ...
                <input id="name" name="name" type="text" required="" class="field ph mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" placeholder="Name" fdprocessedid="hgqh4d">
              </div>

              <div>
                <label for="email" class="block text-sm font-semibold text-slate-700 dark:text-slate-200">Work Email</label>
                <input id="email" name="email" type="email" required="" class="field ph mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" placeholder="name@company.com" fdprocessedid="ro47">
              </div>

              <div>
                <label for="website" class="block text-sm font-semibold text-slate-700 dark:text-slate-200">Website</label>
                <input id="website" name="website" type="url" class="field ph mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" placeholder="https://site.com">
              </div>

              <div class="grid sm:grid-cols-2 gap-4">
                <div>
                  <label for="service" class="block text-sm font-semibold text-slate-700 dark:text-slate-200">I’m interested in</label>
                  <select id="service" name="service" class="field mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" fdprocessedid="xbox2m">
                ...
                <div>
                  ...
                  <select id="budget" name="budget" class="field mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" fdprocessedid="j2j9u">
              ...
              <div>
                ...
                <textarea id="message" name="message" rows="4" class="field ph mt-1 w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white/75 dark:bg-slate-900/40 px-4 py-2.5" placeholder="Key goals…" spellcheck="false" aria-label="To enrich screen reader interactions, please activate Accessibility in Grammarly extension settings"></textarea>
              </div>

              <button type="submit" class="w-full inline-flex justify-center items-center gap-2 text-white font-semibold py-3 rounded-xl
                       bg-gradient-to-r from-cyan-500 to-indigo-600 shadow-lg hover:shadow-xl active:scale-[.98] transition" fdprocessedid="paezwt">
                Get Free Plan
                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M5 12h14M12 5l7 7-7 7"></path></svg>
              </button>

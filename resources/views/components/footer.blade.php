    ...
    <div class="max-w-7xl mx-auto px-6 py-14">
      <div class="rounded-3xl p-10 text-center shadow-xl ring-1 ring-slate-200/70 dark:ring-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-xl">
        <h2 class="font-extrabold text-slate-900 dark:text-white leading-tight tracking-tight [text-wrap:balance] drop-shadow-sm"
            style="font-size:clamp(2rem,4.5vw,3.2rem);">
          🚀 Scale Faster with 
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-sky-600 via-cyan-500 to-indigo-500">Lead Generation</span> & 
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-500 to-pink-500">Cold Email Marketing</span>
        </h2>
        <p class="mt-5 text-lg md:text-xl text-slate-600 dark:text-slate-300/90 max-w-3xl mx-auto">
          From verified lists to inbox-ready domains, copy that sparks replies, and sequences that book calls — all under one roof.
        </p>
  ...
  <section class="relative text-center">
    <div class="max-w-5xl mx-auto px-6 py-14">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-x-8 gap-y-3 text-[15px] font-medium">
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">About</a>
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">Career</a>
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">Free Quote</a>
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">Clients</a>
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">Services</a>
        <a href="#" class="hover:text-sky-600 dark:hover:text-sky-400">Terms</a>
      </div>

      <!-- Phone -->
      <div class="mt-10 text-3xl md:text-4xl font-extrabold flex items-center justify-center gap-3">
        <span class="text-green-500">💬</span>
        <a href="tel:+8801927802206" class="hover:opacity-90">+880 1927-802206</a>
      </div>

      <!-- Address + Email -->
      <div class="mt-6 text-sm text-slate-500 dark:text-slate-400 space-y-2">
        <p>📍 Jashore 7400, Bangladesh</p>
        <p>✉️ <a href="mailto:khalid@khalidit.com" class="underline hover:text-sky-600">khalid@khalidit.com</a></p>
      </div>

    ...
    <div class="mt-12 flex flex-col-reverse lg:flex-row items-center gap-10">
      ...
      <div class="w-full lg:w-1/2 animate-fadeInUp delay-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <!-- List Building -->
          <div class="group rounded-2xl border border-gray-100 dark:border-gray-800 bg-white/90 dark:bg-gray-900 p-5 shadow hover:shadow-lg transition-all hover:-translate-y-1">
      ...
      <!-- Right Visual -->
      <div class="w-full lg:w-1/2 flex justify-center animate-fadeInUp delay-200">

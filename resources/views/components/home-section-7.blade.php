<!-- Section Seven Start (Lead Gen + Cold Email, Responsive) -->
<section id="section-seven" class="relative isolate overflow-hidden">
  ...
  <div class="relative text-center py-14 px-5 md:px-8 max-w-7xl mx-auto" data-animate>
    <!-- Title -->
    <h2 class="reveal-up title-hero mx-auto max-w-4xl text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
    ...
    <p class="reveal-up mt-4 text-base sm:text-lg text-slate-700 dark:text-gray-300 max-w-3xl mx-auto">
      We plan, build, and run scalable outbound programs that consistently create qualified pipeline—without long contracts.
    </p>

    <!-- quick process (mobile-first) -->
    <ol class="reveal-up mt-6 flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm text-slate-700 dark:text-gray-300">
      <li class="rounded-full border border-slate-200/70 dark:border-white/15 bg-white/60 dark:bg-white/5 px-3 py-1">ICP & Offer Mapping</li>
      <li class="rounded-full border border-slate-200/70 dark:border-white/15 bg-white/60 dark:bg-white/5 px-3 py-1">List Building + Enrichment</li>
      <li class="rounded-full border border-slate-200/70 dark:border-white/15 bg-white/60 dark:bg-white/5 px-3 py-1">Deliverability Setup</li>
      <li class="rounded-full border border-slate-200/70 dark:border-white/15 bg-white/60 dark:bg-white/5 px-3 py-1">Personalized Sequencing</li>
      <li class="rounded-full border border-slate-200/70 dark:border-white/15 bg-white/60 dark:bg-white/5 px-3 py-1">A/B Testing & Scale</li>
    </ol>

    <!-- services grid -->
    <div class="stagger mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
      <!-- Card 1: ICP Research -->
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-cyan-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-cyan-600 dark:text-cyan-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 21l-4.35-4.35"/><circle cx="11" cy="11" r="8"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">ICP Research & Offer</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">Nail your ideal customer profile, pain points, and irresistible offer before a single email is sent.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
      ...
      <!-- Card 2: List Building -->
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-indigo-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 5h18M3 10h18M3 15h18M3 20h18"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">List Building & Enrichment</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">Clean, verified contacts with role, tech stack, revenue, and trigger events.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
      ...
      <!-- Card 3: Deliverability -->
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-emerald-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-emerald-600 dark:text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">Deliverability Setup</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">Inbox-first infrastructure so your emails actually land.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
          <li>• SPF, DKIM, DMARC</li>
          <li>• Dedicated domains & warmup</li>
          <li>• Rotation & reputation guard</li>
        </ul>
      </article>
      ...
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-pink-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-pink-600 dark:text-pink-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20l-7-7a5 5 0 017-7l0 0a5 5 0 017 7l-7 7z"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">Smart Personalization</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">First-line hooks & body variants that read truly 1:1—at scale.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
      ...
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-amber-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-amber-600 dark:text-amber-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M5 6h14M5 18h14"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">Sequencing & A/B Testing</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">Subject lines, CTAs, and send windows tuned for replies.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
          <li>• Multi-branch cadences</li>
          <li>• Time-zone aware sending</li>
      ...
      <article class="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/80 dark:bg-[#0b1220]/80 backdrop-blur p-5 text-left shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-purple-500/15 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-purple-600 dark:text-purple-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18"/><path d="M7 13l3 3 7-7"/></svg>
          </div>
          <h3 class="font-semibold text-slate-900 dark:text-white">Reporting & CRM Handoff</h3>
        </div>
        <p class="mt-3 text-sm text-slate-600 dark:text-gray-300">Clear dashboards and seamless sync to your pipeline.</p>
        <ul class="mt-3 space-y-1 text-sm text-slate-700 dark:text-gray-300">
          <li>• Reply & meeting tracking</li>
          <li>• SQL, MQL, and stage tagging</li>
          <li>• HubSpot/Salesforce ready</li>
        </ul>
      </article>
    </div>
    ...
    <p class="reveal-up mt-3 text-xs text-slate-600 dark:text-gray-400">SPF/DKIM • Dedicated Domains • Warmup • Reply Detection • CRM Sync</p>
  </div>
...
<style>
  /* Title aesthetics (better contrast + premium gradient) */
  ...
  #section-seven .title-underline{
    display:block; height:10px; margin:.35rem auto 0; max-width: 480px;
...
<script>
  (function(){
        ...
        const io = new IntersectionObserver((entries)=>{
          entries.forEach(entry=>{
            if(entry.isIntersecting){
              root.classList.add('is-visible'); io.unobserve(root);
            }
          })
        },{threshold:0.18});
        io.observe(root);
    ...
    // ripple vars set on pointerdown

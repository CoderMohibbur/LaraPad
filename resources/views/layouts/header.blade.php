        ...
        <div class="w-full p-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center"><button
                        class="mr-3 cursor-pointer rounded p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white lg:inline"><span
                            class="sr-only">Toggle sidebar</span><svg stroke="currentColor" fill="currentColor"
                            stroke-width="0" viewBox="0 0 20 20" class="h-6 w-6" height="1em" width="1em"
                ...
                <div class="flex items-center lg:gap-3">
                    <div class="flex items-center"><button
                            class="cursor-pointer rounded p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700 dark:focus:ring-gray-700 lg:hidden"><span
                                class="sr-only">Search</span><svg stroke="currentColor" fill="currentColor"
                                stroke-width="0" viewBox="0 0 20 20" class="h-6 w-6" height="1em" width="1em"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
                        ...
                        <div data-testid="flowbite-tooltip" tabindex="-1"
                            ...
                            id=":r0:" role="tooltip" style="position: absolute; top: 60.8px; left: 1122.76px;">
                                ...
                                <ul class="">
                                    <div class="max-w-[24rem]">
                                        ...
                                        <div><a href="#"
                                                ...
                                                <div class="w-full pl-3">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            Livingston</span>&nbsp;mentioned you in a
                                                        comment:&nbsp;<span
                                            ...
                                            <div class="inline-flex items-center gap-x-2"><svg stroke="currentColor"
                                                    fill="currentColor" stroke-width="0" viewBox="0 0 20 20"
                                                    class="h-6 w-6" height="1em" width="1em"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path>
                                                    <path fill-rule="evenodd"
                                                        d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
                                                        clip-rule="evenodd"></path>
                                                </svg><span>View all</span></div>
                                        </a>
                                    </div>
                                </ul>
                            </div>
                        ...
                        <div class="w-fit dark:text-white" data-testid="flowbite-tooltip-target"><button
                                class="flex items-center"><span
                                    class="rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700"><span
                                        class="sr-only">Apps</span><svg stroke="currentColor" fill="currentColor"
                        ...
                        <div data-testid="flowbite-tooltip" tabindex="-1"
                            class="z-10 w-fit rounded-xl divide-y divide-gray-100 shadow transition-opacity duration-100 invisible opacity-0 border border-gray-200 bg-white text-gray-900 dark:border-none dark:bg-gray-700 dark:text-white"
                            id=":r2:" role="tooltip" style="position: absolute; top: 60.8px; left: 1232.8px;">
                            <div class="rounded-xl text-sm text-gray-700 dark:text-gray-200">
                                <ul class="">
                                    <div
                                    ...
                                    <div class="grid grid-cols-3 gap-4 p-4"><a href="#"
                                            class="block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600"><svg
                    ...
                    <div class="hidden lg:block">
                        <div class="w-fit dark:text-white" data-testid="flowbite-tooltip-target"><button
                                class="flex items-center"><span><span class="sr-only">User menu</span>
                                    <div class="flex justify-center items-center space-x-4"
                                        data-testid="flowbite-avatar">
                                        <div class="relative"><img alt=""
                                                class="!rounded-full rounded w-8 h-8 rounded"
                                                data-testid="flowbite-avatar-img" src="../images/users/neil-sims.png">
                                        </div>
                                    </div>
                                </span></button></div>
                        <div data-testid="flowbite-tooltip" tabindex="-1"
                            class="z-10 w-fit rounded-xl divide-y divide-gray-100 shadow transition-opacity duration-100 invisible opacity-0 border border-gray-200 bg-white text-gray-900 dark:border-none dark:bg-gray-700 dark:text-white"
                            id=":r4:" role="tooltip" style="position: absolute; top: 56.8px; left: 1307.54px;">
                            <div class="rounded-xl text-sm text-gray-700 dark:text-gray-200">
                                <ul class="">
                                    <div class="block py-2 px-4 text-sm text-gray-700 dark:text-gray-200"><span
                                            class="block text-sm">Neil Sims</span><span

    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                    aria-controls="page" data-collapse-toggle="page" aria-expanded="false">

                    <i data-lucide="notepad-text"></i>
                    <span class="menu-text hidden flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Page
                        Editor</span>
                    <svg sidebar-toggle-item="" class="menu-text hidden w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <ul id="page" class="space-y-2 hidden">
                    <li>
                        <a href="/admin/pages/"
                            class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">All
                            Pages</a>
